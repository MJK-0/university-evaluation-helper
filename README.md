...
- Supports common rating scales such as:
  - 0 = Strongly Disagree
  - 1 = Disagree
  - 2 = Neutral
  - 3 = Agree
  - 4 = Strongly Agree
- Works as an unpacked browser extension in Microsoft Edge and Google Chrome.
...
If you downloaded it as a ZIP file, extract it first.
...
Make sure you select the folder that contains this file:
...
1. Click the extensions icon in the browser toolbar. It usually looks like a puzzle piece.
2. Find the extension named University Evaluation Helper or مساعد تقييمات الجامعة.
3. Click the pin icon next to it.

The extension icon should now appear directly in the browser toolbar.
...
After choosing the rating option, click the button in the popup.

The button may be named:
...
The extension will then select the chosen option for all matching radio-button questions on the current page.
...
Click the puzzle icon in the browser toolbar and pin the extension.
...
- This extension only selects answers. It does not submit the evaluation automatically.
